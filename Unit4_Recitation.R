...
points(boston$LON[latlonlm$fitted.values >= 21.2], boston$LAT[latlonlm$fitted.values >= 21.2], col="green", pch="$")
...
#10 values we are tesing for cp:
0:10 * 0.001
...
#output of cross-validation using different CP parameters
