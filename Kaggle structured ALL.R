...
#model 4 CART model on significant variable


# 
# table(vote.train$Party,PredTest>0.5)
# Error in table(vote.train$Party, PredTest > 0.5) : 
#   all arguments must have the same length

#will having predict function 
#does this happen if I just change the NA's to anything else?

PredTest[is.na(PredTest)]=0

summary(vote.test$fuckthis)
